/**
 * Enhanced interface for LineupComponent. This component will further enhance
 * the team's lineup with methods not provided in the basic interface.
 */
public interface LineupComponentEnhanced extends LineupComponentKernel {
     ...
     *
     * @ensures the highest-scoring player for each position is in the starting
     *          lineup
     */
    void makeBest();
